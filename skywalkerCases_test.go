...
var (
	testCases = []TestCase{
		{"Everything", skywalker.LTBlacklist, nil, skywalker.LTBlacklist, nil, skywalker.LTBlacklist, nil, false, false, []string{
			...
			filepath.Join(root, "sub/subfolder"),
			filepath.Join(root, "sub/subfolder/just.txt"),
			filepath.Join(root, "sub/subfolder/a.log"),
			filepath.Join(root, "sub/subfolder/few.pdf"),
			filepath.Join(root, "sub/subfolder/files"),
		...
		{"BlackList Directory", skywalker.LTBlacklist, nil, skywalker.LTBlacklist, []string{"sub"}, skywalker.LTBlacklist, nil, false, false, []string{
			root,
			filepath.Join(root, "subfolder"),
			filepath.Join(root, "the"),
			filepath.Join(root, "the/just.txt"),
		...
		{"BlackList Directory FilesOnly", skywalker.LTBlacklist, nil, skywalker.LTBlacklist, []string{"sub"}, skywalker.LTBlacklist, nil, true, false, []string{
			filepath.Join(root, "the/just.txt"),
			filepath.Join(root, "the/a.log"),
			filepath.Join(root, "the/few.pdf"),
			filepath.Join(root, "the/files"),
		...
		{"WhiteList Directory", skywalker.LTBlacklist, nil, skywalker.LTWhitelist, []string{"sub"}, skywalker.LTBlacklist, nil, false, false, []string{
			root,
			filepath.Join(root, "sub"),
			filepath.Join(root, "sub/subfolder"),
			filepath.Join(root, "sub/subfolder/just.txt"),
		...
		{"WhiteList Directory FilesOnly", skywalker.LTBlacklist, nil, skywalker.LTWhitelist, []string{"sub"}, skywalker.LTBlacklist, nil, true, false, []string{
			filepath.Join(root, "sub/subfolder/just.txt"),
			filepath.Join(root, "sub/subfolder/a.log"),
			filepath.Join(root, "sub/subfolder/few.pdf"),
			filepath.Join(root, "sub/subfolder/files"),
